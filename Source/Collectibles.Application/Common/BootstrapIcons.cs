...
/// <summary>
/// The full Bootstrap Icons v1.11.3 icon-name list. Single source of truth for
/// the UI examples page, the icon picker, and home-page content validation.
/// </summary>
public static class BootstrapIcons
{
    ...
    public static bool IsValid(string? name) =>
        !string.IsNullOrWhiteSpace(name) && Lookup.Contains(name);
}
