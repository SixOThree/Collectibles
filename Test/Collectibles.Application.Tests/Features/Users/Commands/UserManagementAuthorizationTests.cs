...
public class UserManagementAuthorizationTests
{
    ...
    private static Mock<ICurrentUserService> CreateCurrentUser(
        string? userId = "user-1", bool isAdmin = false, bool isUserManager = false)
    {
    ...
    public async Task CreateUserShouldThrowWhenNotAdministrator()
    {
        ...
        _userManagementServiceMock.Verify(
            x => x.CreateUserAsync(
                ...
                It.IsAny<bool>(), It.IsAny<List<string>>(), It.IsAny<CancellationToken>()),
            Times.Never);
    }
    ...
    public async Task UpdateUserShouldSucceedWhenUserManager()
    {
        ...
        _userManagementServiceMock.Verify(
            x => x.UpdateUserAsync(
                "other-user", "other@example.com", It.IsAny<string?>(), It.IsAny<string?>(),
                It.IsAny<bool>(), It.IsAny<List<string>>(), It.IsAny<bool>(), It.IsAny<CancellationToken>()),
            Times.Once);
    }
    ...
    [Fact]
    public async Task GetUsersListShouldSucceedWhenUserManager()
    {
        _userManagementServiceMock
            .Setup(x => x.GetUsersAsync(
                It.IsAny<int>(), It.IsAny<int>(), It.IsAny<string?>(), It.IsAny<string?>(),
                It.IsAny<bool?>(), It.IsAny<string?>(), It.IsAny<bool>(), It.IsAny<CancellationToken>()))
            .ReturnsAsync(new Collectibles.Application.Common.Models.PaginatedList<UserListDto>(new List<UserListDto>(), 0, 1, 10));
