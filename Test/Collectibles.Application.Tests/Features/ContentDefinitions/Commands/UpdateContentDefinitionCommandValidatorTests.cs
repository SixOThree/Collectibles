...
public class UpdateContentDefinitionCommandValidatorTests
{
    private readonly UpdateContentDefinitionCommandValidator _validator = new();
    ...
    private static UpdateContentDefinitionCommand CreateValidCommand()
    {
        return new UpdateContentDefinitionCommand
        {
            Id = 1,
            Name = "Trading Cards",
            IsGlobal = true,
